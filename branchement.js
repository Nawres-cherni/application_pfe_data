...
const saveRec=()=> {
fetch("http://10.0.2.2:3000/envoyer-Branchement",{
method:"POST",
headers:{
...
.then(data=>{
console.log(data)
Alert.alert(`Votre Branchement est envoyer avec succes`)
})
.catch(err=>{
...
<RNPickerSelect
            onValueChange={(payerBranch) => setPayerBranch(payerBranch)}
        ...
        onChangeText={text=>setPayerBranch(text)}
            items={[
